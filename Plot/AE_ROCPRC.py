...
for model_name in model_names:
    ...
    for method in methods:
        ...
        model_save_dir = os.path.join(
            ...
            model_name,
            method,
            f'num_features_{best_i}',  # Save the model corresponding to the best_i features
            'best_fold_auc',
...
for idx in range(8):
    ...
    if plot_type == 'roc':
        ...
        ax.set_title(f"{title_map[model_name]} - ROC", fontsize=30, fontweight='bold')
    else:
        ...
        ax.set_title(f"{title_map[model_name]} - PRC", fontsize=30, fontweight='bold')
...
# Save the figure
plot_save_path = os.path.join(output_plots_dir, 'AE_ROCPRC.svg')
plt.tight_layout()
