...
def plot_autogluon_ifs_graph_auc():
    ...
    manual_label_positions = {
        "LightGBMXT": {"shap":1, "mrmr": 1, "anova": 1},
        "ExtraTreesGini": {"shap": 1, "mrmr": 1, "anova": 1},
        "ExtraTreesEntr": {"shap": 1, "mrmr": 1, "anova": 1},
        "CatBoost": {"shap": 1, "mrmr": 1, "anova": 1}
    }
    ...
    for model_idx, model_name in enumerate(models):
        ...
        ax.set_xlabel('Number of Features', fontsize=label_fontsize,
    ...
    plot_filename = os.path.join(output_dir, 'ML_IFS.svg')
